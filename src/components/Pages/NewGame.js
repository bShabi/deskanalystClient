...
class _NewGame extends React.Component {
  constructor(props) {
    super(props)
  ...
  handleSubmit = (event) => {
    ...
    // if (gameData.myTeamFinalScore > gameData.anotherFinalScore)
    //   gameData.statusGame = 1
    // else if (gameData.myTeamFinalScore < gameData.anotherFinalScore)
    //   gameData.statusGame = -1
    // else {
    //   gameData.statusGame = 0
    // }
  ...
  render() {
    ...
    if (myTeamName === ' ') {
      toast.warning("No Team plase contect with Owner")
      ...
      <Fragment>
        ...
        <div className="container">
          ...
          <form>
            ...
            <button onClick={this.handleSubmit} className="btn btn-Form">Upload CSV!</button>
          </form>
...
export const NewGame = withRouter(_NewGame);
